<div class="teachers-leave">
				...
				<div class="row g-0">
					...
					<div class="col-8">
						<div class="card-body">
							...
							<h6 class="card-title">Tổng giáo lý viên</h6>
				...
				<div class="row g-0">
					...
					<div class="col-8">
						<div class="card-body">
							...
							<h6 class="card-title">Được phê duyệt</h6>
	...
	<div class="container mt-5">
		...
		<ul class="nav nav-pills">
			...
			<li class="nav-item">
				<span class="nav-link me-2 active cursor-pointer" id="pending-leave-tab" onclick="tabButtonClicked('pending')">Phê duyệt</span>
			</li>
			<li class="nav-item me-2">
				<span class="nav-link cursor-pointer " id="approved-leave-tab" onclick="tabButtonClicked('approved')">Chờ xử lý</span>
			</li>
			<li class="nav-item">
				<span class="nav-link me-2 cursor-pointer" id="rejected-leave-tab" onclick="tabButtonClicked('rejected')">Từ chối</span>
			</li>

<div class="showAttendence feedback">
    ...
    <div class="container" style="display: flex;">
        ...
        <div class="row g-3 align-items-center">
            ...
            <div class="col-auto">
                ...
                <option value="12c">Dự Trưởng</option>
                <option value="11c">Dự Tòng</option>
                <option value="11s">Vào Đời 2</option>
                <option value="10">Vào Đời 1</option>
                <option value="9">Bao Đồng 3</option>
                <option value="8">Bao Đồng 2</option>
                <option value="7">Bao Đồng 1</option>
                <option value="6">Thêm Sức 2</option>
                <option value="5">Thêm Sức 1</option>
                <option value="4">Rước lễ 2</option>
                <option value="3">Rước lễ 1</option>
                <option value="2">Khai Tâm 2</option>
                <option value="1">Khai Tâm 1</option>
    ...
    <div class="container" style="display: flex;">
        <div class="row g-3 align-items-center">
            <div class="col-auto">
                <label for="inputPassword6" class="col-form-label">Thiếu Nhi </label>
            </div>
            <div class="col-auto">
                ...
                <div class="col-12 col-md-4" style="max-height: 400px;">
                    ...
                    <div class="card border-0 w-100 rounded-0 my-3" style="width: 12rem;">
                        ...
                        <div class="card-header" id="settings-card-header">
                            <h5 class="card-title mb-0">Thiếu Nhi</h5>
                        </div>

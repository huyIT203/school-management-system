                                    ...
                                    <div class="box100 _flex-container" style="width: 100%;">
                                        <div class="btn-group row" style="width: 100%;" role="group"
                                            ...
                                            <button type="button" class="btn btn-secondary col-auto"
                                                style="border: none;height: 50px;" id="prev-page-btn">Sau</button>
                                            ...
                                            <button type="button" class="btn btn-secondary col-auto"
                                                style="border: none;height: 50px;" id="next-page-btn">Trước</button>
                                        </div>
                                    </div>
                                    <!-- </div> -->
                                    ...
                                    <table class="table table-striped scrollTable" style="width: 100%;">
                                        <thead>
                                            <tr id="headingRow" style=" border-bottom: 2px solid #FBC02D;">
                                                <!-- <th scope="col">#</th> -->
                                                <th class="tableData" scope="col">Bắt đầu</th>
                                                <th class="tableData" scope="col">Kết Thúc</th>
                                        ...
                                        <table class="table table-striped scrollTable" style="width: 100%;">
                                            <thead>
                                                <tr style="border:none !important;">
                                                    <!-- <th scope="col">#</th> -->
                                                    <th class="invisiable" scope="col">Bắt đầu</th>
                                                    <th class="invisiable" scope="col">Kết thúc</th>

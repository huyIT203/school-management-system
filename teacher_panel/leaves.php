                            ...
                            <?php if (!isset($_GET['id'])) { ?>
                                <div>
                                    <form class="needs-validation" id="leave-form" action="#" method="post">
                                        <div class="px-3">
                                            <div class="mb-3">
                                                <label for="leave-type" class="form-label">Chọn lý do nghỉ</label>
                                                <select class="form-select" style="width: 100%;" name="leave-type" id="leave-type" required>
                                                    <option selected disabled value="">--select--</option>
                                                    <option>Nghỉ phép</option>
                                                    <option>Nghỉ phép y tế</option>
                                                    <option>Nghỉ thai sản</option>
                                                    <option>Nghỉ kết hôn</option>
                                                    <option>Tang lễ</option>
                                                    <option>Nghỉ phép khác</option>
                                                </select>
                                            ...
                                            <div class="mb-3">
                                                <label for="leave-desc" class="form-label">giải thích Tại sao lại nghỉ? </label>
                                            ...
                                            <div class="mb-3">
                                                <label for="start-date" class="form-label">Ngày bắt đầu nghỉ</label>
                                    ...
                                    <form class="needs-validation" id="leave-form" action="#" method="post">
                                        <div class="px-3">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" style="width: 100%;" name="leave-type" id="leave-type" required>
                                                    <option selected disabled value="">--select--</option>
                                                    <option  <?php selectdCheck($dataRow['leave_type'],'Casual Leave'); ?>>Nghỉ phép</option>
                                                    <option <?php selectdCheck($dataRow['leave_type'],'Medical Leave'); ?>>Nghỉ phép y tế</option>
                                                    <option <?php selectdCheck($dataRow['leave_type'],'Maternity Leave'); ?>>Nghỉ thai sản</option>
                                                    <option <?php selectdCheck($dataRow['leave_type'],'Marriage Leave'); ?>>Nghỉ kết hôn</option>
                                                    <option <?php selectdCheck($dataRow['leave_type'],'Paternity Leave'); ?>>Tang lễ</option>
                                                    <option <?php selectdCheck($dataRow['leave_type'],'Other Leave'); ?>>Nghỉ phép khác</option>
                                                </select>
                                                <div class="invalid-feedback">
                                                    required!
                                                </div>

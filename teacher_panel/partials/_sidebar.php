<div class="sidebar">
    <a href="dashboard.php" class="logo">
        ...
        <img src="../images/1.png">
          <div class="logo-name"><span class="text-warning">G</span><span class="darkTextColor">L</span><span class="text-warning">V</span></div>
    </a>
    ...
    <ul class="side-menu main-side-board">
        ...
        <li><a href="noticeboard.php"><i class='bx bxs-bookmark'></i>Bảng Thông Báo</a></li>
        <li><a href="timetable.php"><i class='bx bx-table'></i>Thời Khóa Biẻu</a></li>
        <li><a href="syllabus.php"><i class='bx bxs-file-blank'></i>Giáo Trình</a></li>
        <li><a href="notes.php"><i class='bx bx-note'></i>Ghi Chú</a></li>
        <li><a href="marks.php"><i class='bx bx-paste'></i>Điểm</a></li>
        <li><a href="leaves.php"><i class='bx bxs-hourglass-top'></i>Nghỉ Phép</a></li>
        <li><a href="settings.php"><i class='bx bx-cog'></i>Cài đặt</a></li>
    </ul>
    <ul class="side-menu">
        <li>

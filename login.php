  ...
  <div class="container">
    ...
    <div class="cover">
      <div class="front">
        ...
        <div class="text">
          <span class="text-1">Giáo xứ Hạnh Thông Tây<br></span>
          <span class="text-2">Quang Trung,Phường 11, Quận Gò Vấp</span>
        </div>
      </div>
    ...
    <div class="forms">
      <div class="form-content">
        <div class="login-form">
          ...
          <div class="title" id='board-title'>Đăng Nhập</div>
          ...
          <form action="index.php" id="login-form" method="post">
            <div class="input-boxes">
              <div class="input-box">
                ...
                <input type="email" name="email" placeholder="Nhập email của bạn" id='loginEmail' required>
              </div>
              <div class="input-box">
                <i class="fas fa-lock"></i>
                <input type="password" name="password" placeholder="Nhập mật khẩu của bạn" id="password" required>
                <i class="bi bi-eye-fill" style="margin-left:auto;margin-right: 6px;" id="togglePassword"></i>
              </div>
              <div class="text"><a id="forgotpassword">Quên mật khẩu?</a></div>
          ...
          <form action="index.php" id="forgotPassword-form" method="post" style="display:none;">
            ...
            <div class="input-boxes">
              ...
              <div class="text" style="margin-bottom: 20px;display:flex">
                <a id="backToLogin">Trở về trang đăng nhập</a>
              </div>
          ...
          <form id="otpVarification-form" method="post" style="display:none;">
            ...
            <div class="input-boxes">
              ...
              <div class="text" style="margin-bottom: 20px;display:flex">
                ...
                <a id="resendOTP" style='margin-left: auto;'>Gửi OTP?</a>
              </div>

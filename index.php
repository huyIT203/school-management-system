          ...
          <div class="col-12 col-md-6 d-flex justify-content-center get-started" style="height: 550px;">
            <div class=" d-flex justify-content-center align-items-center">
              <div>
                <div class="big-title">
                  <h1>Học hỏi và</h1>
                  <h1>Hãy nuôi dưỡng niềm tin ngay bây giờ.</h1>
                </div>
                <p class="text">
                Tối ưu hóa quản lý, kết nối cộng đồng và
                 nâng cao chất lượng giáo dục giáo lý trong nhà thờ.
                </p>
                <div class="cta">
                  <a href="login.php" class="btn">Bắt đầu thôi nào</a>
                </div>
